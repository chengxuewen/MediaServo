...
./mediaservo.sh package host|bindings  # dist/ 双包发布（D-H13）: mediaservo-host-<ver>.tar.gz + mediaservo-sdk-<ver>.tar.gz（包内含版本顶层目录 + CHANGES.md 自动变更清单——git log 机械生成，无 git 环境降级跳过）
```
