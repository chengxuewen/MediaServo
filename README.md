...
./mediaservo.sh package host|bindings  # dist/ 双包发布（D-H13）: mediaservo-host-<ver>.tar.gz + mediaservo-sdk-<ver>.tar.gz（包内含版本顶层目录 + CHANGES.md=仓根 CHANGELOG.md 直拷，面向使用方的人读更新日志）
```
